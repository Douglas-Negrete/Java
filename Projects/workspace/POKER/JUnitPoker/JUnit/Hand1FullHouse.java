...
public class Hand1FullHouse {

	@Test
	public void testHand1FullHouse()
	{
		Card c1 = new Card("Diamonds", "3");
		Card c2 = new Card("Diamonds", "3");
		Card c3 = new Card("Hearts", "3");
		Card c4 = new Card("Diamonds", "6");
	...
	public void testFullHouse()
	{
		...
		Card c6 = new Card("Hearts", "4");
		Card c7 = new Card("Clubs", "4");
		Card c8 = new Card("Clubs", "4");
		Card c9 = new Card("Clubs", "2");
		Card c10 = new Card("Clubs", "2");
